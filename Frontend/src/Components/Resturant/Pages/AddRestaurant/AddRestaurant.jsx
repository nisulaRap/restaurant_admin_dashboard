		...
		<div className='layout2'>
			...
			<div className='add1'>
				...
				<form className='flex-col' onSubmit={onSubmitHandler}>
					<div className="add-img-upload1 flex-col">
					...
					<div className='add-inputs1 flex-col'>
						<p>Restaurant Name</p>
						<input
							type="text"
					...
					<div className='add-status1 flex-col'>
					...
					<button type='submit' className='add-btn1'>Add Restaurant</button>
				</form>
			</div>
		</div>
